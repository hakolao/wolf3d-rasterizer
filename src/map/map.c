...
/*   Updated: 2020/12/06 23:46:50 by ohakola          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			map_init_image_assets(t_hash_table **map_images)
{
	...
	hash_map_add(*map_images, c_floor,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/floor.bmp"));
	hash_map_add(*map_images, c_floor_start,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/floor_start.bmp"));
	hash_map_add(*map_images, c_wall_up,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/wall_up.bmp"));
	hash_map_add(*map_images, c_wall_right,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/wall_right.bmp"));
	hash_map_add(*map_images, c_wall_down,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/wall_down.bmp"));
	hash_map_add(*map_images, c_wall_left,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/wall_left.bmp"));
	hash_map_add(*map_images, c_block_nw,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/block_nw.bmp"));
	hash_map_add(*map_images, c_block_ne,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/block_ne.bmp"));
	hash_map_add(*map_images, c_block_se,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/block_se.bmp"));
	hash_map_add(*map_images, c_block_sw,
		l3d_read_bmp_32bit_rgba_surface("assets/map_editor/block_sw.bmp"));
}
