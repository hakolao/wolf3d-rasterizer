...
/*   Updated: 2020/12/03 14:51:43 by ohakola+vei      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->texture_files[0] = "assets/textures/test_texture2.bmp";
	data->texture_files[1] = "assets/textures/test_texture2.bmp";
	data->texture_files[2] = "assets/textures/test_texture2.bmp";
	data->texture_files[3] = "assets/textures/test_texture2.bmp";
	data->texture_files[4] = "assets/textures/test_texture2.bmp";
	data->texture_files[5] = "assets/textures/test_texture2.bmp";
	...
	data->normal_map_files[0] = "assets/textures/test_texture_normal2.bmp";
	data->normal_map_files[1] = NULL;
	data->normal_map_files[2] = "assets/textures/test_texture_normal2.bmp";
	data->normal_map_files[3] = "assets/textures/test_texture_normal2.bmp";
	data->normal_map_files[4] = "assets/textures/test_texture_normal2.bmp";
	data->normal_map_files[5] = "assets/textures/test_texture_normal2.bmp";
